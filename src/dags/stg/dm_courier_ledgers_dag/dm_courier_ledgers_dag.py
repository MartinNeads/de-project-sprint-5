...
from stg.dm_courier_ledgers_dag.courier_ledgers_loader import courier_ledgerLoader
...
def sprint5_cdm_dm_courier_ledgers_dag():
    ...
    @task(task_id="courier_ledgers_load")
    ...
    courier_ledgers_dict  # type: ignore


cdm_dm_courier_ledgers_dag = sprint5_cdm_dm_courier_ledgers_dag()
